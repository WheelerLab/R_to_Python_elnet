...
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_rf_grid_split_chr"+chrom+"_chunk"+chunk+".txt", "w").write("gene_id"+"\t"+"gene_name"+"\t"+"chr"+"\t")
for i in n_estimators:
     open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_rf_grid_split_chr"+chrom+"_chunk"+chunk+".txt", "a").write(str(i)+"\t")

#second table file for writing out all grid search results
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_rf_grid_split_parameter_per_gene_chr"+chrom+"_chunk"+chunk+".txt", "w").write("parameters"+"\t"+"gene_id"+"\t"+"gene_name"+"\t"+"chr"+"\t"+"avg_cv_R2")
...
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_svr_grid_split_parameter_per_gene_chr"+chrom+"_chunk"+chunk+".txt", "w").write("parameters"+"\t"+"gene_id"+"\t"+"gene_name"+"\t"+"chr"+"\t"+"avg_cv_R2")
...
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_knn_grid_split_parameter_per_gene_chr"+chrom+"_chunk"+chunk+".txt", "w").write("parameters"+"\t"+"gene_id"+"\t"+"gene_name"+"\t"+"chr"+"\t"+"avg_cv_R2")

#text file where to write out the cv results
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_best_grid_split_rf_cv_chr"+chrom+"_chunk"+chunk+".txt", "w").write("Gene_ID"+"\t"+"Gene_Name"+"\t"+"CV_R2"+"\t"+"n_estimators"+"\t"+"time(s)"+"\n")
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_best_grid_split_knn_cv_chr"+chrom+"_chunk"+chunk+".txt", "w").write("Gene_ID"+"\t"+"Gene_Name"+"\t"+"CV_R2"+"\t"+"n_neigbors"+"\t"+"weights"+"\t"+"p"+"\t"+"time(s)"+"\n")
open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_best_grid_split_svr_cv_chr"+chrom+"_chunk"+chunk+".txt", "w").write("Gene_ID"+"\t"+"Gene_Name"+"\t"+"CV_R2"+"\t"+"kernel"+"\t"+"degree"+"\t"+"C"+"\t"+"time(s)"+"\n")


#read in the previous results and take all the genes except the last one so as to rebuild model starting from it
old_rf = pd.read_csv("/home/pokoro/data/mesa_models/python_ml_models/ALL_results/grid_split/ALL_best_grid_split_rf_cv_chr6_chunk2_104g.txt", sep="\t")
rf_genes = list(old_rf.Gene_ID[0:old_rf.shape[0]-1]) #capture all genes except last one
old_knn = pd.read_csv("/home/pokoro/data/mesa_models/python_ml_models/ALL_results/grid_split/ALL_best_grid_split_knn_cv_chr6_chunk2_104g.txt", sep="\t")
knn_genes = list(old_knn.Gene_ID[0:old_knn.shape[0]-1]) #capture all genes except last one
old_svr = pd.read_csv("/home/pokoro/data/mesa_models/python_ml_models/ALL_results/grid_split/ALL_best_grid_split_svr_cv_chr6_chunk2_104g.txt", sep="\t")
...
for gene in genes:
    ...
    if (type(cis_gt) != int) & (cis_gt.shape[1] > 0):
         ...
         if gene not in rf_genes:
             ...
             open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_best_grid_split_rf_cv_chr"+chrom+"_chunk"+chunk+".txt", "a").write(gene+"\t"+gene_name+"\t"+rf_cv+"\t"+n+"\t"+rf_tt+"\n")

             #extract mean R2 score per gene per parameter
             cv = pd.DataFrame(rfgs.cv_results_)
             open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_rf_grid_split_chr"+chrom+"_chunk"+chunk+".txt", "a").write("\n"+gene+"\t"+gene_name+"\t"+chrom+"\t")
             for i in range(len(cv)):
                  open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_rf_grid_split_chr"+chrom+"_chunk"+chunk+".txt", "a").write(str(cv.mean_test_score[i])+"\t")
                  open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_rf_grid_split_parameter_per_gene_chr"+chrom+"_chunk"+chunk+".txt", "a").write("\n"+str(cv.param_n_estimators[i])+"\t"+gene+"\t"+gene_name+"\t"+chrom+"\t"+str(cv.mean_test_score[i])+"\t")
         ...
         if gene not in svr_genes:
             ...
             open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_best_grid_split_svr_cv_chr"+chrom+"_chunk"+chunk+".txt", "a").write(gene+"\t"+gene_name+"\t"+svr_cv+"\t"+svr_kernel+"\t"+svr_degree+"\t"+svr_c+"\t"+svr_tt+"\n")

             #extract mean R2 score per gene per parameter
             cv = pd.DataFrame(svrgs.cv_results_)
             for i in range(len(cv)):
                  open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_svr_grid_split_parameter_per_gene_chr"+chrom+"_chunk"+chunk+".txt", "a").write("\n"+str(cv.params[i])+"\t"+gene+"\t"+gene_name+"\t"+chrom+"\t"+str(cv.mean_test_score[i])+"\t")
         ...
         if gene not in knn_genes:
             ...
             open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_best_grid_split_knn_cv_chr"+chrom+"_chunk"+chunk+".txt", "a").write(gene+"\t"+gene_name+"\t"+knn_cv+"\t"+knn_n+"\t"+knn_w+"\t"+knn_p+"\t"+knn_tt+"\n")

             #extract mean R2 score per gene per parameter
             cv = pd.DataFrame(knngs.cv_results_)
             for i in range(len(cv)):
                  open("/home/pokoro/data/mesa_models/python_ml_models/"+pop+"_results/2nd_grid/104g_2nd_"+pop+"_knn_grid_split_parameter_per_gene_chr"+chrom+"_chunk"+chunk+".txt", "a").write("\n"+str(cv.params[i])+"\t"+gene+"\t"+gene_name+"\t"+chrom+"\t"+str(cv.mean_test_score[i])+"\t")
