...
ypred_frame_svr.to_csv("/home/pokoro/data/mesa_models/mesa_pheno/thrombotic/pred_expr/chunk/chr"+str(chrom)+"_chunk"+chunk+"_"+tr_pop+"_2_"+pop+"_svr_rbf_pred_gene_expr.txt", header=True, index=True, sep="\t")
